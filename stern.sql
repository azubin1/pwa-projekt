...
-- Database: `stern`
--
CREATE DATABASE IF NOT EXISTS `stern` DEFAULT CHARACTER SET latin2 COLLATE latin2_croatian_ci;
USE `stern`;
...
(20, '11.06.2025', 'jsijisojisissjdisjodsajid', 'djasjpdspdsajdsjdjsa', 'jdasjddopsajdsaopjdspjdaidjas', 'clanakslika.jpg', 'politika', 0);
